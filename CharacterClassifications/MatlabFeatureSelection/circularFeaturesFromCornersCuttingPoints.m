function [ featureArray ] = circularFeaturesFromCornersCuttingPoints( fname )
%circularFeatures will write features of circular 
close all;
featureArray = [];
step = 30;

fileID = fopen([fname,'-cornercut12.txt'],'w');
...
%     sumofElements = max(centroids)+min(centroids);
    ...
    featureArray = [featureArray,size(centroids,1)];
